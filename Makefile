...
_gettestservercert:
	...
	&& $(openssl) x509 -req -in server.csr -CA rootCA.pem -CAkey rootCA.key -CAcreateserial -passin pass:testca -out server.crt -days 825 -sha256
...
gentestcert: _gentestca _gettestservercert _gettestclientcert
